...
def get_neighbors(index, radius, height, width):
    ...
    mask = R < radius
    return (X[mask] + Y[mask]*width).astype(np.int32), R[mask]
...
class ImageSegmenter:
    ...
    def __init__(self, filename):
        ...
        image = imageio.imread(os.path.join('preprocessing', filename))
        self.image = image
...
if __name__ == '__main__':
    ...
    # ImageSegmenter("test.png").segment()
